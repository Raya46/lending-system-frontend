...
const Sidebar = () => {
  ...
  const getActiveSection = () => {
    ...
    if (path === "/history-log") return "history";
    if (path.startsWith("/class-log")) return "class";
  ...
  const handleNavigation = (section) => {
    ...
    else if (section === "history") navigate("/history-log");
    else if (section === "class") navigate("/class-log");
    else if (section === "inventory") navigate("/inventory");
